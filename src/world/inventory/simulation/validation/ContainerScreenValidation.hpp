...
public:
    ...
    static std::unique_ptr<ContainerScreenValidatorBase> createContainerScreenValidator(const ContainerScreenContext& ctx);
    ...
    std::shared_ptr<SimpleSparseContainer> getOrCreateSparseContainer(ContainerEnumName enumName);
};