...
public:
    ...
    void addValidSlotForContainerCallback(ContainerEnumName enumName, const std::function<bool(int)> callback);
    ...
    void addItemAllowedInContainerCallback(ContainerEnumName enumName, const std::function<bool(const ItemStackBase&)> callback);
};